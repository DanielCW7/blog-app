        ...
        <div className="shadow-xl bg-gray-900">
            <div className="h-12 max-w-7xl m-auto px-12">
                ...
                {/* mobile */}
                {
                    isOpen 
                    ?
                    <div className="md:hidden flex flex-col gap-10 justify-center h-screen w-screen fixed bg-black left-0">
                        <Link href="/" className="text-center" onClick={toggleNav}><span> Home </span></Link>
                        <Link href="/about" className="text-center" onClick={toggleNav}><span> About </span></Link>                    
                        <Link href="/contact" className="text-center" onClick={toggleNav}><span> Contact </span></Link>                    
