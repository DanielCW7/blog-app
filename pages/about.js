    ...
    return (
        <div className="max-w-7xl m-auto text-black p-10"> 
            ...
            <p>
                ...
                express my interests in movie-watching, comicbook collecting, 
                and general breakdowns for topics I enjoy talking about. This project is a fantastic way to practice and illustrate 
            ...
            <br/>
            <p>
                As far as app usage goes, this app is built solely out of interest in blogging my innermost thoughts on certain subjects
                and shouldn&apos;t be taken seriously in any manner! It&apos;s only a fun project with which I aim to increase my skills and 
